...
class AdminRegisteredUserStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            'first_name' => 'required',
            'last_name'  => 'required',
            'email'      => ['required', 'email', Rule::unique('shop_registered_users')],
            'group_id'   => 'required|between:1,8',
    ...
    public function messages()
    {
        return [
            ...
            'group_id.required'        => trans('shop::admin.registered_users.group_id_required'),
            'group_id.between'         => trans('shop::admin.registered_users.group_id_invalid'),
