        ...
        Route::group(['prefix' => 'settings'], static function () {
            ...
            Route::group(['prefix' => 'internal-integrations'], static function () {
                ...
                Route::group(['prefix' => 'facebook'], static function () {
                    Route::group(['prefix' => 'conversation-api'], static function () {
                        Route::get('edit', [InternalIntegrationsController::class, 'facebookConversationApiEdit'])->name('admin.shop.settings.internal-integrations.facebook.conversation-api.edit');
                        Route::post('update', [InternalIntegrationsController::class, 'facebookConversationApiUpdate'])->name('admin.shop.settings.internal-integrations.facebook.conversation-api.update');
                    });
                });
            });
        });
