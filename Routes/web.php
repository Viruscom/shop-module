...
Route::group(['prefix' => 'admin', 'middleware' => ['auth']], static function () {
    ...
    Route::prefix('basket')->group(function () {
        ...
        Route::get('/order/preview/{id}', [BasketController::class, 'previewOrder'])->name('basket.order.preview');
        Route::get('/order/create', [BasketController::class, 'createOrder'])->name('basket.order.create');
        Route::post('/order/store', [BasketController::class, 'storeOrder'])->name('basket.order.store');
    });
