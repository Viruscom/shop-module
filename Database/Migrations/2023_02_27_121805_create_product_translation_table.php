...
class CreateProductTranslationTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('product_translation', function (Blueprint $table) {
            ...
            $table->string('title_additional_secound')->nullable()->default(null);
            ...
            $table->text('text_additional_secound')->nullable()->default(null);
            ...
            $table->text('redirect_url_to_shop')->nullable()->default(null);
            $table->timestamps();
