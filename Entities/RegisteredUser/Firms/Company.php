<?php
    ...
    class Company extends Model
    {
         ...
         * @var array
         */
        protected $fillable = ['user_id', 'email', 'phone', 'street', 'street_number', 'country_id', 'state_id', 'city_id', 'zip_code', 'company_name', 'company_eik', 'company_vat_eik', 'company_mol', 'company_address', 'is_default', 'is_deleted'];
