...
class OrderUpdatedToAdminMailable extends Mailable
{
    ...
    {
        return $this->view('shop::emails.orders.order_updated_to_admin')
            ->with(['order' => $this->order,
                    'shopSettings' => $this->shopSettings,
                    'socialLinks' => $this->socialLinks,
                    'lawPages' => $this->lawPages])->subject(trans('shop::admin.email_template_order_updated_to_admin.updated_order_arrived') . $this->order->id);
    }
}
