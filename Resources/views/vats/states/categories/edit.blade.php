...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Update State VAT category {{$category->vat_category->name}} for {{$category->state->name}}({{$category->state->country->name}})
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('vats.countries.states.categories.update',['id' => $category->id])}}">
                            @csrf
