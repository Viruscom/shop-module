...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Create State VAT category for {{$state->name}}({{$state->country->name}})
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('vats.countries.states.categories.store',['id'=>$state->id])}}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="vat_category_id" class="form-control @error('vat_category_id') is-invalid @enderror" name="vat_category_id" autofocus required>
                                        ...
                                        @foreach($state->country->vat_categories as $category)
