                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                                            ...
                                                            <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center">
                                                                <tr>
                                                                    <td width="100" align="left">
                                                                        <img align="left" width="260" style="display:block;width:100%;max-width:260px;" alt="img" src="{{ asset('website/email_icons/logo_black.png') }}">
                                                                    </td>
                                                                    <td width="30">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td class="container-padding" align="center" bgcolor="#F5F5F3">
                                                            <table class="row" border="0" width="480" cellpadding="0" cellspacing="0" align="center">
                                                                <tr>
                                                                    <td height="30">&nbsp;</td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 14px;color: #282828;">{!! trans('messages.email_hello') !!} {{ $order->name }},</td>
                                                                </tr>
                                                                <tr>
                                                                    <td height="18">&nbsp;</td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 14px;color: #282828;line-height: 22px">
                                                                        {{ __('messages.email_your_order_number') }} {{ $order->id }} {{ __('messages.email_in') }} <span style="color: #000000;">{{ url('/') }}</span> {{ __('messages.email_is_with_status') }} <b>{{ $order->statusHumanReadable() }}</b>.
                                                                        <br>
                                                                        <br>
                                                                        <br>
                                                                        <br>
                                                                        {{ __('messages.email_wish_you_nice_day') }}
                                                                        <br>
                                                                        {{ __('messages.email_shop_team') }} <span style="color: #000000;">{{ url('/') }}</span>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    @foreach($settings as $setting)
                                                                        ...
                                                                        @if($setting->key == 'socials_instagram_url' && $setting->value != '')
                                                                            <td width="25">
                                                                                <a href="{{ url($setting->value) }}"><img width="25" style="display:block;width:100%;max-width:25px;" src="{{ asset('website\email_icons\instagram_white.png') }}"></a>
