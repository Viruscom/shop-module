    ...
    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
        <div class="panel-body">
            <ul class="nav">
                ...
                <li><a href="https://main.reklamnipodaraci.com/admin/product_attributes"><img src="{{ asset('admin/assets/images/product_attribute.svg') }}" alt="Атрибути" width="18" style="margin-right: 12px;"> <span>{!! trans('shop::admin.product_attributes.index') !!}</span></a></li>
                <li><a href="{{ route('admin.products.characteristics.index') }}"><img src="{{ asset('admin/assets/images/product_characteristics.svg') }}" alt="Характеристики" width="18" style="margin-right: 12px;"> <span>{!! trans('shop::admin.product_characteristics.index') !!}</span></a></li>
                <li><a href="https://main.reklamnipodaraci.com/admin/product_combinations"><img src="{{ asset('admin/assets/images/product_combinations.svg') }}" alt="Комбинации" width="18" style="margin-right: 12px;"> <span>{!! trans('shop::admin.product_combinations.index') !!}</span></a></li>
