    ...
    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
        <div class="panel-body">
            <ul class="nav">
                ...
                <li><a href="https://main.reklamnipodaraci.com/admin/product_attributes"><img src="https://main.reklamnipodaraci.com/admin/assets/images/product_attribute.svg" alt="Атрибути" width="18" style="margin-right: 12px;"> <span>{!! trans('shop::admin.product_attributes.index') !!}</span></a></li>
                <li><a href="https://main.reklamnipodaraci.com/admin/product_characteristics"><img src="https://main.reklamnipodaraci.com/admin/assets/images/product_characteristics.svg" alt="Характеристики" width="18" style="margin-right: 12px;"> <span>{!! trans('shop::admin.product_characteristics.index') !!}</span></a></li>
                <li><a href="https://main.reklamnipodaraci.com/admin/product_combinations"><img src="https://main.reklamnipodaraci.com/admin/assets/images/product_combinations.svg" alt="Комбинации" width="18" style="margin-right: 12px;"> <span>{!! trans('shop::admin.product_combinations.index') !!}</span></a></li>
...
<div class="panel panel-default">
    ...
    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
        <div class="panel-body">
            <ul class="nav">
                <li><a href="{{ route('admin.shop.dashboard') }}"><i class="fas fa-tv"></i> <span>{!! trans('shop::admin.shop.dashboard') !!}</span></a></li>
                ...
                <li><a href="{{ url('/admin/shop/gifts') }}"><i class="fas fa-gift"></i> <span>{!! trans('shop::admin.product_gifts.index') !!}</span></a></li>
