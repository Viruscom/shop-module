...
<form action="{{ route('admin.shop.orders.create.save', ['id' => $order->id]) }}" method="POST">
    @csrf
                ...
                @if(is_null($basket) || $basket->basket_products->count()<1)
                    <div>
                        <h3 class="title-main title-border" style="display: flex;justify-content: space-between;">
                            ...
                            @include('shop::admin.orders.create.add_products_modal')
                        </h3>
                        ...
                        <div class="col col-2of3">
                            ...
                            <div class="col-inner">
                                <div class="product-boxes">
                                    @if(!is_null($basket) || $basket->basket_products->count())
                                                        ...
                                                        <div class="prod-inner-content">
                                                            <div class="prod-qty hover-images">
                                                                <div class="input-group-prod">
                                                                    <form action="{{ route('admin.shop.orders.create.add_product', ['id' => $order->id]) }}" method="post" class="d-inline-block">
                                                                        @csrf
                                                            ...
                                                            @foreach($basketProduct->additives as $additive)
                                                                <div class="box-row">
                                                                    ...
                                                                    <div class="aside">
                                                                        ...
                                                                        <form action="{{ route('admin.shop.orders.create.remove_extension', ['id' => $order->id]) }}" method="post">
                                                                            @csrf
                                        ...
                                        <div class="box-row box-row-promo">
                                            @if($basket->promo_code)
                                                ...
                                                <div class="delete-promo-code">
                                                    <a href="{{ route('admin.shop.orders.create.delete_promo_code', ['id' => $order->id]) }}">{{ __('shop::front.basket.delete_promo_code') }}</a>
                                                </div>
                                            @endif

                                            <div class="form-wrapper form-wrapper-alt">
                                                <form method="post" enctype="multipart/form-data" action="{{ route('admin.shop.orders.create.apply_promo_code', ['id' => $order->id]) }}">
                                                    @csrf
                                                    <div class="form-body">
                                                        <div class="form-row">
                    ...
                    <div class="col-xs-12 p-0 m-t-10">
                        <div class="bg-grey top-search-bar" style="margin-bottom: 0px;">
                            <div class="action-mass-buttons pull-right">
                                ...
                                <a href="{{ route('admin.shop.orders.create.cancel') }}" role="button" class="btn btn-lg back-btn margin-bottom-10"><i class="fa fa-reply"></i></a>
                            </div>
                        </div>
                    </div>
                @endif
