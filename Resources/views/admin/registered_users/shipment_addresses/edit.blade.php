...
@section('content')
    <form class="my-form" action="{{ url('/admin/shop/clients/'.$client->id.'/shippment_addresses/'.$address->id.'/update') }}" method="POST" data-form-type="store" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group @if($errors->has('city')) has-error @endif">
                    ...
                    <input class="form-control" type="text" name="city" value="{{ (old('city')) ? old('city') : $address->city }}" autocomplete="off" required>
                    @if($errors->has('city'))
                ...
                <div class="form-group @if($errors->has('post_code')) has-error @endif">
                    ...
                    <input class="form-control" type="text" name="post_code" value="{{ (old('post_code')) ? old('post_code') : $address->post_code }}" autocomplete="off" required>
            ...
            <div class="col-md-6">
                <div class="form-group @if($errors->has('address')) has-error @endif">
                    ...
                    <input class="form-control" type="text" name="address" value="{{ (old('address')) ? old('address') : $address->address }}" autocomplete="off" required>
                ...
                <div class="form-group @if($errors->has('phone')) has-error @endif">
                    ...
                    <input class="form-control" type="text" name="phone" value="{{ (old('phone')) ? old('phone') : $address->phone }}" autocomplete="off">
                    @if($errors->has('phone'))
                ...
                <div class="form-group @if($errors->has('landline_phone')) has-error @endif">
                    ...
                    <input class="form-control" type="text" name="landline_phone" value="{{ (old('landline_phone')) ? old('landline_phone') : $address->landline_phone }}" autocomplete="off">
