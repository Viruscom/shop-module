...
@section('content')
    <form class="my-form" action="{{ route('admin.shop.registered-users.payment-addresses.update', ['id' => $registeredUser->id, 'address_id' => $address->id]) }}" method="POST" data-form-type="store" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                @include('admin.partials.on_edit.form_fields.input_text_without_lang', ['model' => $address, 'fieldName' => 'email', 'label' => 'Email', 'required' => true])
