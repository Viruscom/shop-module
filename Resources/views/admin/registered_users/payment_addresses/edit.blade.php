...
@section('content')
    <form class="my-form" action="{{ url('/admin/shop/clients/'.$client->id.'/billing_addresses/'.$address->id.'/update') }}" method="POST" data-form-type="store" enctype="multipart/form-data">
