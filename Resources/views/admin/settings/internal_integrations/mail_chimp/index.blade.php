                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="MAILCHIMP_API_KEY" value="{{ $mailChimp->MAILCHIMP_API_KEY }}" class="form-control" required>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-md-3">API SERVER:</label>
                                    <div class="col-md-6">
                                        <input type="text" name="MAILCHIMP_API_SERVER" value="{{ $mailChimp->MAILCHIMP_API_SERVER }}" class="form-control" required>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-md-3">LIST ID:</label>
                                    <div class="col-md-6">
                                        <input type="text" name="MAILCHIMP_LIST_ID" value="{{ $mailChimp->MAILCHIMP_LIST_ID }}" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        </div>
