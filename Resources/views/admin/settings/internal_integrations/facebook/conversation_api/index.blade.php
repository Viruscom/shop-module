						...
						<div class="portlet light bordered">
							...
							<div class="portlet-body">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" name="ACCOUNT_TOKEN" value="{{ $mailChimp->ACCOUNT_TOKEN }}" class="form-control" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" name="PIXEL_ID" value="{{ $mailChimp->MAILCHIMP_API_SERVER }}" class="form-control" required>
									</div>
								</div>
