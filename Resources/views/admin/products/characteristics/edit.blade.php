                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a role="button" class="btn back-btn margin-bottom-10 cancel-position-change" current-position="{{ $productCharacteristic->position }}" data-dismiss="modal"><i class="fa fa-reply"></i> назад</a>
                                    </div>
                                </div>
                            </div>
                        </div>
