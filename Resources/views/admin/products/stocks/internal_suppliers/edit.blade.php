...
@section('content')
    <form class="my-form" action="{{ route('products.stocks.internal_suppliers.store') }}" method="POST" data-form-type="store" enctype="multipart/form-data">
        <div class="col-xs-12 p-0">
            ...
            <div class="bg-grey top-search-bar">
                <div class="action-mass-buttons pull-right">
                    ...
                    <a href="{{ route('products.stocks.internal_suppliers.index') }}" role="button" class="btn btn-lg back-btn margin-bottom-10"><i class="fa fa-reply"></i></a>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="tab-content">
                    @foreach($languages as $language)
                        @php
                            ...
                            $internalSupplierTranslation = $supplier->translations->where('language_id', $language->id)->first();
                        @endphp
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="{{ route('products.stocks.internal_suppliers.store') }}" role="button" class="btn back-btn margin-bottom-10"><i class="fa fa-reply"></i> назад</a>
                            </div>
                        </div>
                    </div>
                </div>
